...
int main () {
    char a; // Char, character adalah variabel yang dapat diisi dengan 1 karakter. menggunakan ' ' untuk mengisinya
    string a1; // String, dapat menyimpan teks. menggunakan " " untuk mengisinya
